// =============================================================================
// Claude.ai Chat Exporter v8.4.1 — Self-contained, API-primary, no external deps
// =============================================================================
		...
		if (apiMessages.length > 0) {
			...
			turns = domOrder.map((uuid) => {
				...
				return {
					...
					rawTs: message.created_at || null, // [v8.4.1]
...
(() => {
  ...
  let savedW = "l"; // [v8.4] default L
  try { savedW = localStorage.getItem(WKEY) || "l"; } catch {}
