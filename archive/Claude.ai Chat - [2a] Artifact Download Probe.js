...
(async () => {
  ...
  window.fetch = function (...args) {
    const url =
      typeof args[0] === "string" ? args[0] : args[0]?.url || "(Request obj)";
  ...
  appendOverlay("✅ All hooks installed. Clicking first Download button...\n");
  ...
  const title =
    cell?.querySelector(".line-clamp-1")?.textContent?.trim() || "(unknown)";
  ...
  // Click overlay to dismiss, or auto-remove after 8s
